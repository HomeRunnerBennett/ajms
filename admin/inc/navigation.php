            ...
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="">
                  ...
                  <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=reports/statement_of_comprehensive_income" class="nav-link text-light nav-reports_statement_of_comprehensive_income">
                          <i class="nav-icon fas fa-file"></i>
                          <p>
                  ...
                  <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=reports/statement_of_financial_position" class="nav-link text-light nav-reports_statement_of_financial_position">
                          <i class="nav-icon fas fa-file"></i>
                          <p>
                  ...
                  <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=reports/statement_of_cashflow" class="nav-link text-light nav-reports_statement_of_cashflow">
                          <i class="nav-icon fas fa-file"></i>
                          <p>
                  ...
                  <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=reports/statement_of_changes_in_equity" class="nav-link text-light nav-reports_statement_of_changes_in_equity">
                          <i class="nav-icon fas fa-file"></i>
                          <p>
                  ...
                  <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=reports/budget_vs_actual" class="nav-link text-light nav-reports_budget_vs_actual">
                          <i class="nav-icon fas fa-file"></i>
                          <p>
                              Budget Vs Actual
                          </p>
                    ...
                    <li class="nav-header">Accounts Schedule</li>
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=accounts_schedule" class="nav-link text-light nav-accounts_schedule">
                        <i class="nav-icon fas fa-file"></i>
                        <p>
                          Accounts Schedule
                        </p>
                    ...
                    <li class="nav-header">Key Performance Indicators</li>
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=kpi" class="nav-link text-light nav-kpi">
